...
for a,b in enumerate(type_list):
    for i,j in enumerate(b):
        ...
        print(55)'''
# ------------------------------------------------
Button(windos, text='<---', width='50', bg='black', fg='#1d953f', command=clearend).place(x=0, y=20)
...
Button(windos, width='10', text='**', bg='#121a2a', fg='#d1c7b7', command=lambda: put_num('**')).place(x=0 * 90,
                                                                                                       y=5 * 45)
